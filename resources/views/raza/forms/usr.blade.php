...
<div class="form-group"> {!!Form::label('Cada cuando tiene mes de en celo: ')!!}
  {!!Form::number('dias_de_celo',null,['class'=>'form-control', 'placeholder'=>'En dias','style'=>'text-transform:uppercase'])!!} </div>
<div class="form-group"> {!!Form::label('Duración de gestación o eclosión: ')!!}
  {!!Form::number('semanas_de_gestacion',null,['class'=>'form-control', 'placeholder'=>'En semanas','style'=>'text-transform:uppercase'])!!} </div>
