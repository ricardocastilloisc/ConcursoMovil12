<div class="form-group">
  ...
  {!!Form::text('nombre',null,['class'=>'form-control', 'placeholder'=>'Ingresa el Nombre de la Raza','style'=>'text-transform:uppercase'])!!}
</div>
...
<div class="form-group">
  ...
  {!!Form::number('meses_de_gestacion',null,['class'=>'form-control', 'placeholder'=>'En meses','style'=>'text-transform:uppercase'])!!}
</div>
