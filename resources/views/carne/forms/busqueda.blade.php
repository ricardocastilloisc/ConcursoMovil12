...
<table align="rigth">
  <tbody>
    ...
    necesidad de redirccionarte a otra area de la aplicacion -->
                ...
                <div class="row"> 
                  ...
                  <div class="col-md-12">
                    <table align="left">
                      ...
                      <tr>
                        <td> {!!Form::open(['route'=>'carne.index','method'=>'GET', 'class'=>'navbar-form navbar-left','role'=>'search'])!!}
                  ...
                  <div class="col-md-12">
                    <table align="left">
                      <tr>
                        <td colspan="2"> {!!Form::label('Fecha de muerte:')!!} </td>
                      </tr>
                      <tr>
                        <td> {!!Form::open(['route'=>'carne.index','method'=>'GET', 'class'=>'navbar-form navbar-left','role'=>'search'])!!}
                          <div class="form-group"> {!!Form::date('fecha_de_muerte',null, ['class' => 'form-control'])!!} </div></td>
                        <td><button type="submit" class="btn btn-default">Buscar</button>
                          {!!Form::close()!!} </td>
                      </tr>
                    </table>
      ...
      @if ((isset($_GET['animal_id']))||(isset($_GET['fecha_de_muerte'])) )
      <td> || </td>
      <!--Redirigete-->
      <td> {!!link_to_route('carne.index', $title='Volver a ver todos lo animales', null, $attributes=['class'=>'btn btn-primary'])!!} </td>
      @endif 
      <!--termina--> 
    </tr>
  </tbody>
